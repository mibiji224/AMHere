...
export default function ScheduleRequestSection({ requests }: { requests: ScheduleRequest[] }) {
        ...
        <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-card rounded-xl shadow-2xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-200 border border-border">
            ...
            <div className="bg-primary p-4 flex justify-between items-center text-primary-foreground">
               <h3 className="font-bold">Change Schedule</h3>
            ...
            <form action={async (formData) => {
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-muted-foreground uppercase">Desired Schedule / Reason</label>
                <textarea 
                  name="reason" 
                  rows={4} 
                  required 
                  placeholder="e.g. Can I switch my Tuesday shift to Saturday? I have classes." 
