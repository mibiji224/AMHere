...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const isActive = (path: string) => {
    // Exact match for the employees page to distinguish it from others if needed
    ...
    <div className="min-h-screen bg-background flex transition-colors duration-300">
      ...
      `}>
        ...
        <div className="flex p-6 items-center gap-3 border-b border-border flex-shrink-0">
          ...
          <div>
            <Link href="/admin/dashboard" className="font-bold text-lg block leading-none text-primary hover:opacity-80 transition">
              AMHere
            </Link>
